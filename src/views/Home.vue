...
const publishSite = async () => {
  ...
  // Les deux URLs équivalentes
  const urlUid  = `https://musrh.github.io/SaaasGenerator/#/?uid=${uid}`
  const urlSlug = `https://musrh.github.io/SaaasGenerator/#/${slug}`
        ...
        <div v-if="publishStatus !== 'published'" class="publish-form">
          <div class="pub-field">
            ...
            <div class="pub-url-wrap">
              <span class="pub-url-prefix">SaaasGenerator/#/</span>
            ...
            <div v-if="publishAddress" class="pub-preview-url">
              🔗 musrh.github.io/SaaasGenerator/#/{{ publishAddress.toLowerCase().replace(/[^a-z0-9-]/g,'-') }}
            </div>
            <div v-if="currentUser && publishAddress" class="pub-preview-url" style="color:var(--text3);font-size:11px;margin-top:4px">
              🆔 uid: musrh.github.io/SaaasGenerator/#/?uid={{ currentUser.uid }}
            </div>
          </div>
